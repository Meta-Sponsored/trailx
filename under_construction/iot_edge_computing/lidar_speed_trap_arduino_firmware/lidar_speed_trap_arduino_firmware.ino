...
int speedLimit = 5;//Set the speed limit (mph). Once the speed is greater than the limit, we will print the speed
...
void loop()
{
  ...
  if (millis() - lastReading > (LOOPTIME-1)) // 49)
  {
    ...
    if(instantMPH > maxMPH and instantMPH > speedLimit)
    {
      Serial.print("Speed: ");
